...
//            System.out.println(stringValue);
    ...
    @Test
    public void fileReaderTest_ReadSmallFiles() throws IOException {
        File file = Path.of("resources", "test.txt").toFile();
    ...
    @Test
    public void readingFileOneCharacterAtAtime() throws IOException {
        File file = Path.of("resources", "test.txt").toFile();
        try (FileReader fileReader = new FileReader(file)) {
            int i;
    ...
    @Test
    public void readingAFileLineUsingFileReader() throws IOException {
        File file = Path.of("resources", "test.txt").toFile();
